                ...
                <div className="p-8 bg-[var(--background-subtle)] space-y-4">
                    <div className="grid gap-3">
                        {themes.map((t) => (
                            ...
                            >
                                {/* Color Preview */}
                                <div className={cn("size-12 rounded-full border-2 border-[var(--border)] shadow-sm shrink-0", t.color)} />

                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2">
                                        <span className={cn("font-semibold text-base", theme === t.value ? "text-[var(--foreground)]" : "text-[var(--foreground)]")}>
                                            {t.label}
                                        </span>
                                        {theme === t.value && (
