...
export function SettingsPage() {
  ...
  const saveMachine = async () => {
    ...
    const payload: SaveMachineReq = {
      ...
      pcIp: (editingMachine as { pcIp?: string | null; cncIp?: string | null }).pcIp ?? (editingMachine as { pcIp?: string | null; cncIp?: string | null }).cncIp ?? null,
          ...
          {editingMachine ? (
            <div className="grid grid-cols-2 gap-3">
              ...
              <label className="form-label">
                ...
                <input
                  className="form-input"
                  value={(editingMachine as { pcIp?: string | null; cncIp?: string | null }).pcIp ?? (editingMachine as { pcIp?: string | null; cncIp?: string | null }).cncIp ?? ''}
